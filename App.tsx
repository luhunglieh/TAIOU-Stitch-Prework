      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link 
              to="/about" 
              className={`text-sm font-medium transition-colors ${isActive('/about') ? 'text-primary font-bold border-b-2 border-primary pb-0.5' : 'text-[#111418] dark:text-gray-300 hover:text-primary'}`}
            >
              關於我們
            </Link>
            <Link 
              to="/" 
              className={`text-sm font-medium transition-colors ${isActive('/') || location.pathname.startsWith('/article') ? 'text-primary font-bold border-b-2 border-primary pb-0.5' : 'text-[#111418] dark:text-gray-300 hover:text-primary'}`}
            >
              最新文章
            </Link>
            <Link 
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-sm text-[#617589] dark:text-gray-400">
            ...
            <li><Link to="/" className="hover:text-primary transition-colors">最新消息</Link></li>
            <li><Link to="/" className="hover:text-primary transition-colors">產業部落格</Link></li>
            <li><Link to="/" className="hover:text-primary transition-colors">會員專區</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="font-bold text-[#111418] dark:text-white mb-4">資源</h4>
          <ul className="flex flex-col gap-2 text-sm text-[#617589] dark:text-gray-400">
            <li><Link to="/" className="hover:text-primary transition-colors">白皮書下載</Link></li>
            <li><Link to="/" className="hover:text-primary transition-colors">API 文件</Link></li>
            <li><Link to="/" className="hover:text-primary transition-colors">開源專案</Link></li>
            <li><Link to="/" className="hover:text-primary transition-colors">活動行事曆</Link></li>
          </ul>
        </div>
        <div>
